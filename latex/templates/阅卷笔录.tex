...
\begin{document}
    % 黑体小2号
    \title{\zihao{-2}\heiti\textbf\texorpdfstring{xxxx\\ 阅\quad 卷\quad 笔\quad 录}}
    ...
    \vspace{1em}
    \centerline{\zihao{-4}\textbf{2022年09月}}
    ...
    \fancyhead[L]{\includegraphics[scale=0.6]{D:/vt_logos/vt_logo_5.png}}
    ...
    \fancyfoot[C]{\thepage}
    \fancyhead[L]{\includegraphics[scale=1]{./pic/vt_logo.png}}
    \fancyhead[R]{目录}
