...
\item {
    ...
    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.4\textwidth]{./pics/Chapter_6/12.png}
    \end{figure}
    % 2021; 迎春杯三年级真题.pdf ; 16
}

\item {
    如右图, 小鱼老师在为圣诞树准备装饰物, 每个树顶需要放一颗幸运星每一层树的两侧需要各放1个许原球, 一共3层, 小鱼老师数了数, 许愿球比幸运星多 40个, 那么, 小鱼老师装饰了 \underline{\hbox to 20mm{}} 棵圣诞树.
    \begin{figure}[H] 
        \centering
...
\item {
    ...
    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.3\textwidth]{./pics/Chapter_6/14.png}
    \end{figure}
    % 2021 ;  迎春杯四年级真题.pdf ;  12
}

\item {
    如图, 一个$2\times 2\times 2$的正方体六个面已经被染成了不同的六种颜色. 现将其分成4个 的小长方体, 共有\underline{\hbox to 20mm{}}种不同分法.
    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.3\textwidth]{./pics/Chapter_6/15.png}
    \end{figure}
...
\item {
    ...
    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.3\textwidth]{./pics/Chapter_6/23.png}
    \end{figure}
...
\item {
    ...
    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.3\textwidth]{./pics/Chapter_6/2017_1.png}
    \end{figure}
...
\item {
    ...
    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.3\textwidth]{./pics/Chapter_6/2016_3.png}
    \end{figure}
...
\item {
    ...
    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.3\textwidth]{./pics/Chapter_6/2016_4.png}
    \end{figure}
...
\item {
    ...
    \begin{figure}[H] 
        \centering
        \includegraphics[width=0.3\textwidth]{./pics/Chapter_6/2015_2.png}
    \end{figure}
...
%     \begin{figure}[H] 
%         \centering
%         \includegraphics[width=0.5\textwidth]{./pics/Chapter_6/3.png}
%     \end{figure}
...
%     \begin{figure}[H] 
%         \centering
%         \includegraphics[width=0.5\textwidth]{./pics/Chapter_6/1.png}
%     \end{figure}
...
%     \begin{figure}[H] 
%         \centering
%         \includegraphics[width=0.5\textwidth]{./pics/Chapter_6/6.png}
%     \end{figure}
...
%     \begin{figure}[H] 
%         \centering
%         \includegraphics[width=0.5\textwidth]{./pics/Chapter_6/7.png}
%     \end{figure}
...
%     \begin{figure}[H] 
%         \centering
%         \includegraphics[width=0.5\textwidth]{./pics/Chapter_6/5.png}
%     \end{figure}
